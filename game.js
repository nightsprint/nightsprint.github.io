        ...
        function spawnObstacle() {
            ...
            if (isGolden) {
                // 🟡 GOLDEN OBSTACLE
                o.el.style.background = "linear-gradient(135deg, gold, orange)";
                o.el.style.boxShadow =
                    "0 0 15px gold, 0 0 30px orange, 0 0 45px gold";
            } else {
                // 🎨 normal random neon color
            ...
            if (type === "square") {
                o.el.style.width = "32px";
                o.el.style.height = "32px";
                o.el.style.borderRadius = "6px";
            }

            if (type === "rectangle") {
                o.el.style.width = "50px";
                o.el.style.height = "28px";
                o.el.style.borderRadius = "6px";
            }
            ...
            if (type === "circle") {
                o.el.style.width = "32px";
                o.el.style.height = "32px";
                o.el.style.borderRadius = "50%";
            }

            if (type === "pentagon") {
                o.el.style.width = "36px";
                o.el.style.height = "36px";
                o.el.style.borderRadius = "0";
                o.el.style.clipPath =
                    "polygon(50% 0%, 100% 38%, 82% 100%, 18% 100%, 0% 38%)";
            }

            if (type === "stick") {
                o.el.style.width = "14px";
                o.el.style.height = "50px";
                o.el.style.borderRadius = "8px";
            }
        }
